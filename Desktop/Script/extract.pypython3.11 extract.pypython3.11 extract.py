...
if not os.path.exists(base_folder):
    print(f"❌ ERROR: Can't find base folder")
    exit()

print("✅ Found indiana communication folder!")

# Get PNG files from both data folders
all_png_files = []
...
if os.path.exists(folder2):
    ...
    print(f"✅ Found {len(files2)} PNGs in data 2")
...
for i, (folder, png_file) in enumerate(all_png_files):
    ...
    try:
        ...
        for match in matches:
            ...
            # Clean and extract business name
